...
export const agents: Agent[] = [
  {
    ...
    signature: "— Warren",
    tagline: "Give Warren a ticker. He will tell you what the market misses.",
    cta: "Ask Warren →",
    loadingMessages: [
    ...
    emptyState: "Give Warren a ticker. He will tell you what the market misses.",
  ...
  },
  {
    ...
    tagline: "Give Sherlock a rival. He will tell you everything they do not want you to know.",
    ...
    emptyState: "Give Sherlock a rival. He will tell you everything they do not want you to know.",
  ...
  },
  {
    ...
    emptyState: "Drop your prospect list. Harvey will make every single one feel personal.",
