...
export const projects: Project[] = [
  {
    ...
    description: "Built a retrieval-augmented generation system processing 2M+ documents for a Fortune 500 bank. 94% accuracy on complex financial queries.",
  ...
  },
  {
    ...
    description: "Real-time AI trading signal engine analyzing 500+ stocks. Backtested 12% alpha over S&P 500.",
  ...
  },
  {
    ...
    description: "Deployed AI agent system handling 80% of tier-1 support tickets autonomously. Reduced response time from 4hrs to 30s.",
  ...
  {
    name: "MLOps Pipeline",
    description: "End-to-end ML pipeline with auto-retraining, A/B testing, and drift detection. Serves 10M+ predictions/day.",
  ...
  },
  {
    ...
    description: "Migrated 50TB data lake from on-prem Hadoop to AWS. 40% cost reduction with improved query performance.",
  ...
  },
  {
    ...
    description: "Automated content pipeline generating 1000+ SEO-optimized articles/month with human-quality output.",
...
export const pricing = {
  ...
  pro: {
    ...
    price: "$49",
    uses: "Unlimited",
    features: ["All tools included", "Unlimited uses", "Priority support", "API access", "Custom integrations"],
  },
};
